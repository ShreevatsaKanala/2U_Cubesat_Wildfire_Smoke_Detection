...
import { Radio, Wifi, WifiOff, AlertTriangle, Activity, Brain } from "lucide-react";
...
export default function AIStatusPanel() {
  ...
  const isUnavailable = aiStatus.status === "unavailable";
  ...
  const modeText = isUnavailable
    ...
    ? "text-green-400"
    : "text-yellow-400";
  const modeLabel = isUnavailable ? "UNAVAILABLE" : isLive ? "LIVE" : "MOCK";
