...
@router.get("/api/replay/sessions/{session_id}/telemetry")
...
@router.get("/api/replay/sessions/{session_id}/observations")
...
@router.get("/api/replay/sessions/{session_id}/events")
...
@router.post("/api/replay/playback/{session_id}")
